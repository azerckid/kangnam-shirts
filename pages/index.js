    ...
    <div>
      ...
      <Center>
        ...
        <Introduction>
          <h1>강남셔츠룸</h1>
          <p>
            강남 셔츠룸은 일종의 룸 서비스로, 가라오케나 룸처럼 노래나 게임을
            즐기는 시스템과는 다릅니다. 대신 고급스런 인테리어와 함께 퀄리티
            높은 셔츠룸 매니저가 함께 해드리며, 테이블에서 간단한 호구조사와
            함께 술 한 잔하며 즐길 수 있는 곳입니다. 강남의 셔츠룸 시스템은
            전국적으로 전파되어 제주도에서도 강남셔츠룸이 인기가 있습니다 기존의
            퍼블릭 룸싸롱이나 가라오케 시스템과는 다른 좀더 적극적인 매니저들의
            복장과 마인드가 장점인 룸싸롱 입니다 매니저들의 옷차림은 홀복이 아닌
            셔츠를 입어서 강남 셔츠룸이라고 불리 웁니다. 매니저와 전화번호를
            주고 받고 사적으로 연락을 하며 애인사이가 되어 연애를 하시길
            바랍니다. 강남 셔츠룸은 일종의 룸 서비스로, 가라오케나 룸처럼 노래나
            게임을 즐기는 시스템과는 다릅니다. 대신 고급스런 인테리어와 함께
            퀄리티 높은 매니저가 함께 해드리며, 테이블에서 간단한 호구조사와
            함께 술 한 잔하며 즐길 수 있는 곳입니다. 강남 셔츠룸의 매니져들을
            아래 그림으로 대략 소개드립니다.
          </p>
        </Introduction>
        <GridWrapper>
